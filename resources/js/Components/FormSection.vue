...
<template>
  <div
    class="flex sm:flex-row flex-col place-items-center justify-center sm:justify-between sm:gap-2 relative"
  >
    <div
    ...
    <form
      ...
      class="flex flex-col px-4 w-full md:px-0 md:w-1/2 justify-between md:pt-32 pb-4"
    >
      <Card
        ...
        <div class="flex flex-col gap-4 px-8 justify-between md:pt-12 w-full">
          ...
          <div class="flex flex-col place-items-start gap-1 relative">
            ...
            <select
              ...
              id="serviceType"
              class="py-2 text-md md:text-xl w-full border rounded-[7px] px-2"
