...
<template>
    <div
        class="flex flex-col place-items-start justify-center sm:justify-center h-2/3 w-full px-4 sm:pl-6 overflow-hidden gap-4 md:gap-0 md:h-screen transition-transform duration-300 ease-in-out xl:scale-115 xl:translate-x-20 xl:translate-y-20"
    >
        <div
